...
auto edit_distance(database_t && database, query_t && query, align_cfg_t && align_cfg)
{
    ...
    auto refined_align_cfg = align_cfg | seqan3::align_cfg::alignment_result_capture<alignment_result_t>;
    using refined_align_config_t = decltype(refined_align_cfg);
    using edit_traits = edit_traits_type<compute_score_matrix, database_t, query_t, refined_align_config_t>;
    using algorithm_t = seqan3::detail::edit_distance_unbanded<database_t, query_t, refined_align_config_t, edit_traits>;
    auto alignment = algorithm_t{database, query, refined_align_cfg, edit_traits{}};
