...
INSTANTIATE_TYPED_TEST_CASE_P(semi_global, align_edit_distance, semi_global_edit_distance_unbanded_types);
INSTANTIATE_TYPED_TEST_CASE_P(semi_global_max_errors,
                              align_edit_distance,
                              semi_global_edit_distance_max_errors_unbanded_types);
