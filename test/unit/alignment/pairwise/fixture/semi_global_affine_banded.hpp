...
static auto dna4_01_semi_first = []()
{
    return alignment_fixture
    {
        ...
        {
        //        T  ,T  ,T  ,T  ,T  ,A  ,C  ,G  ,T  ,A  ,T  ,G  ,T  ,C  ,C  ,C  ,C  ,C  ,
        ...
        {
        //        T  ,T  ,T  ,T  ,T  ,A  ,C  ,G  ,T  ,A  ,T  ,G  ,T  ,C  ,C  ,C  ,C  ,C  ,
              N  ,N  ,N  ,N  ,N  ,N  ,N  ,N  ,N  ,INF,INF,INF,INF,INF,INF,INF,INF,INF,INF,
...
static auto dna4_03_semi_second = []()
{
    return alignment_fixture
    {
        ...
        {
        //        T  ,T  ,T  ,T  ,T  ,A  ,C  ,G  ,T  ,A  ,T  ,G  ,T  ,C  ,C  ,C  ,C  ,C  ,
              0  ,-11,-12,-13,-14,-15,-16,-17,-18,INF,INF,INF,INF,INF,INF,INF,INF,INF,INF,
        ...
        {
        //        T  ,T  ,T  ,T  ,T  ,A  ,C  ,G  ,T  ,A  ,T  ,G  ,T  ,C  ,C  ,C  ,C  ,C  ,
              N  ,L  ,l  ,l  ,l  ,l  ,l  ,l  ,l  ,INF,INF,INF,INF,INF,INF,INF,INF,INF,INF,
...
static auto dna4_04_semi_second = []()
{
    return alignment_fixture
    {
        ...
        std::vector<std::optional<int32_t>>
        {
        //       A  ,C  ,G  ,T  ,A  ,A  ,A  ,A  ,C  ,G  ,T  ,
             0  ,-11,-12,-13,-14,-15,-16,-17,-18,INF,INF,INF,
