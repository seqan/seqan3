...
{
public:
    using base_t = seqan3::detail::edit_distance_score_matrix_full<word_type, score_type, is_semi_global, use_max_errors>;
...
static constexpr score_type INF = 2147483647;
