...
struct score_matrix : public ::testing::Test
{
    ...
    std::vector<trace_matrix_directions> traces_shorter_rows
    {
        N,  L,  L,  L,  L,  L,  L,  L,  L,  L,  L,  L,  L,  L,  L,  L,  L,
        U,  D,  DL, L,  DL, L,  L,  L,  L,  DL, DL, L,  L,  L,  L,  L,  L,
        U,  U,  D,  D,  L,  DL, L,  L,  L,  L,  L,  DL, DL, L,  L,  L,  L,
    ...
    std::vector<trace_matrix_directions> traces_shorter_cols
    {
        N,  L,  L,  L,  L,  L,  L,
        U,  D,  DL, L,  DL, L,  L,
        U,  U,  D,  D,  L,  DL, L,
    ...
    void score_matrix_test(alignment_score_matrix<options_t...> matrix)
    {
        ...
        EXPECT_EQ(matrix.database(), database);
        EXPECT_EQ(matrix.query(), query);
...
TEST_F(score_matrix, equal)
{
    ...
    alignment_score_matrix matrix_shorter_rows{scores_shorter_rows, database, query};
    alignment_score_matrix matrix_unequal{std::move(scores_unequal), database, query};

    alignment_score_matrix matrix_vector{scores, database, query};
...
{
    alignment_trace_matrix matrix{traces, database, query};
...
TEST_F(trace_matrix, score_matrix)
{
    ...
    alignment_trace_matrix matrix{std::move(score_matrix)};

    trace_matrix_test(std::move(matrix));
}

TEST_F(trace_matrix, score_matrix_indirect)
{
...
TEST_F(trace_matrix, equal)
{
    ...
    alignment_trace_matrix matrix_shorter_rows{traces_shorter_rows, database, query};
    alignment_trace_matrix matrix_unequal{std::move(traces_unequal), database, query};

    alignment_trace_matrix matrix_vector{traces, database, query};
    alignment_trace_matrix matrix_score_matrix{alignment_score_matrix{scores, database, query}};
    alignment_trace_matrix matrix_score_matrix_indirect{scores, database, query};

    EXPECT_EQ(matrix_vector, matrix_vector);
    EXPECT_EQ(matrix_vector, matrix_score_matrix);
    EXPECT_EQ(matrix_vector, matrix_score_matrix_indirect);
    EXPECT_FALSE(matrix_vector == matrix_shorter_cols);
    EXPECT_FALSE(matrix_vector == matrix_shorter_rows);
    EXPECT_FALSE(matrix_vector == matrix_unequal);
    ...
    EXPECT_EQ(matrix_score_matrix, matrix_score_matrix_indirect);
    ...
    EXPECT_EQ(matrix_score_matrix_indirect, matrix_score_matrix_indirect);
    EXPECT_EQ(matrix_score_matrix_indirect, matrix_vector);
    EXPECT_EQ(matrix_score_matrix_indirect, matrix_score_matrix);
    EXPECT_FALSE(matrix_score_matrix_indirect == matrix_shorter_cols);
    EXPECT_FALSE(matrix_score_matrix_indirect == matrix_shorter_rows);
    EXPECT_FALSE(matrix_score_matrix_indirect == matrix_unequal);
}
...
TEST_F(trace_matrix, not_equal)
{
    ...
    EXPECT_FALSE(matrix_vector != matrix_score_matrix_indirect);
    EXPECT_NE(matrix_vector, matrix_shorter_cols);
    EXPECT_NE(matrix_vector, matrix_shorter_rows);
    EXPECT_NE(matrix_vector, matrix_unequal);
    ...
    EXPECT_FALSE(matrix_score_matrix != matrix_score_matrix_indirect);
    ...
    EXPECT_FALSE(matrix_score_matrix_indirect != matrix_score_matrix_indirect);
    EXPECT_FALSE(matrix_score_matrix_indirect != matrix_vector);
    EXPECT_FALSE(matrix_score_matrix_indirect != matrix_score_matrix);
    EXPECT_NE(matrix_score_matrix_indirect, matrix_shorter_cols);
    EXPECT_NE(matrix_score_matrix_indirect, matrix_shorter_rows);
    EXPECT_NE(matrix_score_matrix_indirect, matrix_unequal);
}
