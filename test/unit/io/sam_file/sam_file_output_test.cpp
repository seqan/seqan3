...
TEST(general, construct_by_filename)
{
    /* just the filename */
    {
        ...
        auto filename = tmp.get_path() / "sam_file_output_constructor.sam";
    ...
    {
        seqan3::test::tmp_directory tmp;
        auto filename = tmp.get_path() / "sam_file_output_constructor.xyz";
    ...
    {
        seqan3::test::tmp_directory tmp;
        auto filename = tmp.get_path() / "I/do/not/exist.sam";
...
{
    seqan3::test::tmp_directory tmp;
    auto filename = tmp.get_path() / "in_out.bam";
