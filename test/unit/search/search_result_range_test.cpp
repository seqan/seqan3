...
struct algorithm_result_generator_range_test : ::testing::Test
{
    ...
    using executor_t = seqan3::detail::algorithm_executor_blocking<indexed_queries_t &,
                                                                   ...
                                                                   algorithm_result_t>;
    using algorithm_result_generator_range_t = seqan3::algorithm_result_generator_range<executor_t>;
...
template <>
struct iterator_fixture<algorithm_result_generator_range_test> : algorithm_result_generator_range_test
{
    using iterator_tag = std::input_iterator_tag;
    static constexpr bool const_iterable = false;

    algorithm_result_generator_range_t test_range{executor_t{this->indexed_queries, dummy_search_algorithm{}, algorithm_result_t{}}};
    std::vector<dummy_result_type> expected_range{{0, 0}, {0, 1}, {0, 2}, {0, 3}, {0, 4},
                                                  {1, 0}, {1, 1}, {1, 2}, {1, 3}, {1, 4},
                                                  {2, 0}, {2, 1}, {2, 2}, {2, 3}, {2, 4}};
};

INSTANTIATE_TYPED_TEST_SUITE_P(search_range_iterator, iterator_fixture, algorithm_result_generator_range_test, );

// ----------------------------------------------------------------------------
// Testing alignment range concepts and interfaces.
// ----------------------------------------------------------------------------

TEST_F(algorithm_result_generator_range_test, concept_test)
{
...
TEST_F(algorithm_result_generator_range_test, construction)
{
    ...
    EXPECT_TRUE((std::is_constructible_v<algorithm_result_generator_range_t, executor_t>));
}

TEST_F(algorithm_result_generator_range_test, type_deduction)
{
    seqan3::algorithm_result_generator_range rng{executor_t{indexed_queries, dummy_search_algorithm{}, algorithm_result_t{}}};
    EXPECT_TRUE((std::is_same_v<decltype(rng), algorithm_result_generator_range_t>));
}

TEST_F(algorithm_result_generator_range_test, invoke_begin_on_default_result_range)
{
    seqan3::algorithm_result_generator_range<executor_t> rng{};
    EXPECT_THROW(rng.begin(), std::runtime_error);
}

TEST_F(algorithm_result_generator_range_test, empty_query_range)
{
...
TEST_F(algorithm_result_generator_range_test, issue1799)
{
    std::vector<dummy_result_type> expected_range{{0, 0}, {0, 1}, {0, 2}, {0, 3}, {0, 4},
                                                  {1, 0}, {1, 1}, {1, 2}, {1, 3}, {1, 4},
                                                  {2, 0}, {2, 1}, {2, 2}, {2, 3}, {2, 4}};
    { // move construction
        seqan3::algorithm_result_generator_range rng{executor_t{indexed_queries, dummy_search_algorithm{}, algorithm_result_t{}}};
        seqan3::algorithm_result_generator_range moved_range{std::move(rng)};
