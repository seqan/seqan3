...
std::cout << "database:\t" << (score_matrix.database() | view::to_char) << std::endl;
std::cout << "query:\t\t" << (score_matrix.query() | view::to_char) << std::endl;
std::cout << std::endl;
...
alignment_matrix_formatter{score_matrix}.format();
//! [code]
