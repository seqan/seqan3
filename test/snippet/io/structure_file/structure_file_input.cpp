...
{
//! [auto_temp_deduc]
structure_file_in sf{"/tmp/input.dbn"}; // Vienna with RNA sequences assumed, regular std::ifstream taken as stream
//! [auto_temp_deduc]
}
...
{
//! [arg_spec]
structure_file_in<structure_file_input_default_traits_rna> fin{"/tmp/input.dbn"};
//! [arg_spec]
}
...
structure_file_in<structure_file_input_default_traits_aa,
                  fields<field::SEQ, field::ID, field::STRUCTURE>,
                  type_list<structure_file_format_vienna>> fin{"/tmp/input_aa.dbn"};
...
{
//! [data_out]
structure_file_in fin{"/tmp/input.dbn"};
...
{
//! [skip_fields]
structure_file_in fin{"/tmp/input.dbn", fields<field::ID, field::STRUCTURED_SEQ>{}};
...
{
#if 0 // Code for reading by column
//! [col_read]
struct data_storage_t
{
    concatenated_sequences<rna5_vector>         sequences;
