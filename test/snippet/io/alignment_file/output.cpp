...
alignment_file_output fout{std::filesystem::temp_directory_path()/"my.sam"}; // SAM format detected, std::ofstream opened for file
//! [filename_construction]
}
...
alignment_file_output fout{std::filesystem::temp_directory_path()/"my.sam", fields<field::MAPQ>{}};
//! [format_construction]
}
