...
#include <seqan3/std/ranges>                    // std::ranges::InputRange
...
void foobar(rng_t && range)
{
    ...
    using size_type = std::conditional_t<std::ranges::SizedRange<rng_t>,
    ...
    using size_type = seqan3::detail::lazy_conditional_t<std::ranges::SizedRange<rng_t>,
