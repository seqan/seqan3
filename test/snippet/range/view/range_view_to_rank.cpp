...
int main()
{
    ...
    auto v = vec | seqan3::view::to_rank | seqan3::view::convert<unsigned>;
    seqan3::debug_stream << v << '\n'; // [0,1,3,3,3,2,0,3,0]

    std::vector<seqan3::phred42> qvec{{0}, {7}, {5}, {3}, {7}, {4}, {30}, {16}, {23}};
    auto v3 = qvec | seqan3::view::to_rank | seqan3::view::convert<unsigned>;
    ...
    auto v4 = qcvec | seqan3::view::to_rank | seqan3::view::convert<unsigned>;
