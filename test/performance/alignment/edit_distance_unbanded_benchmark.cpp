...
void seqan3_edit_distance_dna4(benchmark::State & state)
{
    ...
    auto edit_distance_result_cfg = edit_distance_cfg | seqan3::align_cfg::alignment_result_capture<alignment_result_t>;

    using edit_traits_t = seqan3::detail::default_edit_distance_trait_type<seq1_ref_t,
                                                                           seq2_ref_t,
                                                                           decltype(edit_distance_result_cfg),
                                                                           std::false_type>;


    for (auto _ : state)
    {
        seqan3::detail::edit_distance_unbanded edit_distance{seq1, seq2, edit_distance_result_cfg, edit_traits_t{}};
