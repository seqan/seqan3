...
// ============================================================================
//  affine; score; aa; collection
// ============================================================================

template <typename ...align_configs_t>
void seqan3_affine_aa_accelerated(benchmark::State & state, align_configs_t && ...configs)
{
    size_t sequence_length_variance = state.range(0);
    auto data = seqan3::test::generate_sequence_pairs<seqan3::aa27>(sequence_length,
                                                                    set_size,
...
BENCHMARK_CAPTURE(seqan3_affine_aa_accelerated,
                  simd_with_score,
...
void seqan2_affine_aa_accelerated(benchmark::State & state, args_t && ...args)
{
    ...
    size_t sequence_length_variance = state.range(0);
    auto [vec1, vec2] = seqan3::test::generate_sequence_pairs_seqan2<seqan::AminoAcid>(sequence_length,
                                                                                       set_size,
                                                                                       sequence_length_variance);
    ...
    for (auto _ : state)
    {
        ...
        auto res = seqan::globalAlignmentScore(exec, vec1, vec2, scoring_scheme_t{-1, -11});
...
BENCHMARK_CAPTURE(seqan2_affine_aa_accelerated,
                  simd_with_score,
