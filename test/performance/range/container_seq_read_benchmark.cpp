...
BENCHMARK_TEMPLATE(sequential_read, seqan3::bitcompressed_vector, uint32_t);
...
BENCHMARK_TEMPLATE(sequential_read, seqan3::bitcompressed_vector, seqan3::qualified<seqan3::dna4, seqan3::phred42>);
...
BENCHMARK_TEMPLATE(sequential_read, seqan3::bitcompressed_vector, uint32_t, true);
...
BENCHMARK_TEMPLATE(sequential_read, seqan3::bitcompressed_vector, seqan3::qualified<seqan3::dna4, seqan3::phred42>, 1);
...
template <template <typename...> typename container_t, typename spec_t, typename alphabet_t, bool const_ = false>
void sequential_read2(benchmark::State & state)
{
    ...
    using source_ref_t = std::conditional_t<const_,
                                            container_t<alphabet_t, spec_t> const &,
                                            container_t<alphabet_t, spec_t> &>;
