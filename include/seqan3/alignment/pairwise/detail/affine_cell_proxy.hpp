 ...
 * \details
 *
 * This wrapper provides a uniform access to the different elements of the cell within an affine score matrix. This includes
 * the optimal score, the horizontal gap score and the vertical gap score.
 */
