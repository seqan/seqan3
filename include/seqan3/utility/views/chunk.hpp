...
private:
    ...
    // the iterator type if `urng_t` is at least a forward ragne. See class definition for details.
    template <bool const_range>
...
public:
    ...
    constexpr basic_input_iterator(basic_input_iterator<!const_range> const & it) noexcept
    //!\cond
