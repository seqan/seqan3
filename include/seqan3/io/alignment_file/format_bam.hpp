        ...
        if constexpr (!detail::decays_to_ignore_v<align_type>)
        {
            ...
            if (core.l_seq != 0 && offset_tmp == core.l_seq)
            {
                ...
                else
                {
                    ...
                    std::tie(tmp_cigar_vector, ref_length, seq_length) = format_sam::parse_cigar(cigar_view);
        ...
        else
        {
            ...
            else
            {
                ...
                for (auto & [count, operation] : cigar_vector)
                    format_sam::update_alignment_lengths(ref_length, dummy_seq_length, operation.to_char(), count);
            }
