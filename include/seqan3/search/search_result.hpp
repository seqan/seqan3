 ...
 * \tparam cursor_type The type of the cursor; must model seqan3::detail::template_specialisation_of a seqan3::fm_index_cursor
...
//!\cond
    requires (std::integral<query_id_type> || std::same_as<query_id_type, detail::empty_type>) &&
             (detail::template_specialisation_of<cursor_type, fm_index_cursor> || std::same_as<cursor_type, detail::empty_type>) &&
