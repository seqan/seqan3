 ...
 * \ingroup search
 * \tparam query_id_type The type of the query_id; must model std::integral or be the empty_type.
 * \tparam cursor_type The type of the cursor; must model seqan3::fm_index_cursor_specialisation or be the empty_type.
...
class search_result
{
    ...
    static_assert(fm_index_cursor_specialisation<cursor_type> || std::same_as<cursor_type, detail::empty_type>,
                  "The cursor_type must either model fm_index_cursor_specialisation or be detail::empty_type.");
    static_assert(std::integral<reference_id_type> || std::same_as<reference_id_type, detail::empty_type>,
                  "The reference_id_type must either model std::integral or be detail::empty_type.");
    static_assert(std::integral<reference_begin_pos_type> || std::same_as<reference_begin_pos_type, detail::empty_type>,
                  "The reference_begin_pos_type must either model std::integral or be detail::empty_type.");
