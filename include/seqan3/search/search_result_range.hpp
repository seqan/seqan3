...
/*!\brief An input range over seqan3::search_result generated by the given search algorithm.
 * \ingroup search
 ...
 * \details
 *
 * Provides a lazy input-range interface over seqan3::search_result's generated by the underlying search algorithm.
 */
...
private:
    ...
    using result_buffer_value_t = std::ranges::range_value_t<hit_range_t>;
...
private:
    ...
    bool next()
    {
        ...
        {
            res.query_id_ = query_id;
            result_buffer.push_back(std::move(res));
        }
