 ...
 * \brief [DEPRECATED] Provides seqan3::views::enforce_random_access.
 * \deprecated This header will be removed in 3.1. Please use seqan3/utility/views/enforce_random_access.hpp instead.
 */
