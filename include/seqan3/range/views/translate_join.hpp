...
/*!\file
 * \brief [DEPRECATED] Provides seqan3::views::translate_join.
 * \author Sara Hetzel <sara.hetzel AT fu-berlin.de>
 * \deprecated This header will be removed in 3.1. Please use seqan3/alphabet/views/translate_join.hpp instead.
 */
